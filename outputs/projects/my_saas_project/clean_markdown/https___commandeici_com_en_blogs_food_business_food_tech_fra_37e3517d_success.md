!Restaurant owner using a tablet to manage online orders in a Parisian bistro
...
According to Tracxn with direct-ordering SaaS, we name names, and we put real numbers on the table. The goal is simple: help you decide where your euros should go in 2026.
...
Sources for commission ranges: Le Monde, investigations on delivery platform commissions. Numbers vary by contract, city, and volume; treat the table as an order-of-magnitude tool, not a quote.
